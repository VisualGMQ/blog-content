...
是闭集且有界。简单来说就是实心的物体（但是可以有洞，比如圆环）



仿射集：
$$
affX = \{\sum{\lambda_ix_i} | \sum{\lambda_i} = 1\}
$$
而凸集是更严格的仿射集，要求仿射集中$\lambda_i \ge 0$：
$$
affX = \{\sum{\lambda_ix_i} | \sum{\lambda_i} = 1, \lambda_i \ge 0 \}
$$
其中对$\lambda_i$的等价定义是：
$$
\lambda_i \in [0, 1]
$$
仿射无关：对任意的仿射集$Y = \{y_1, y_2, ... y_n\}$来说，有
$$
\{y_2 - y_1, y_3 - y_1, ..., y_i - y_1\}
$$
此向量组线性无关。
